...
const heartbeatInterval = 20000; // More frequent heartbeat
const connectionCheckInterval = 10000; // Faster connection checks
const maxRetries = 15; // Increased number of quick retries

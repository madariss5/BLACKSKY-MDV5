...
module.exports = {
  ...
  // These functions won't work standalone (need the memory manager instance)
  // They're included here for documentation purposes
  runCleanup: () => console.log('[MEMORY-MANAGER] runCleanup can only be used via the memory manager instance'),
  runEmergencyCleanup: () => console.log('[MEMORY-MANAGER] runEmergencyCleanup can only be used via the memory manager instance'),
};
...
// Configuration
const THROTTLE_THRESHOLD = 10; // Messages per minute threshold before throttling
const THROTTLE_EXEMPT_PREFIXES = ['owner', 'admin', 'broadcast', 'report', 'help'];
const PRIORITY_COMMANDS = new Set(['menu', 'help', 'info', 'rules', 'owner']);

...
async function khodamnya() {
  ...
  { name: "Kucing Kulkas\", meaning: \"Kamu misterius dan selalu ada di place-place yang tak terduga." },
  ...
  { name: "Bantal Guling\", meaning: \"Kamu nyaman dan selalu required saat waktu istirahat." },
  ...
  { name: "Senter Mati\", meaning: \"Selalu ada saat required" },
  ...
  { name: "Pensil Penghilang\", meaning: \"Selalu menghilang saat required" },
  ...
  { name: "Tas Pintar\", meaning: \"Selalu memberikan barang yang diperlukan saat required" },

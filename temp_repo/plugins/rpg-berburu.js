...
`
        ...
        m.reply(`\nSepertinya Anda Sudah kecapean, Silahkan Istirahat dulu sekitar *${timers}* Untuk bisa melanjutkan hunting.`)
    }
}

handler.help = ['hunting']
handler.tags = ['rpg']
handler.command = /^(hunting|hunt)$/i
handler.rpg = true

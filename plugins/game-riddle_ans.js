...
handler.before = async function (m) {
    ...
    if (!m.quoted || !m.quoted.fromMe || !m.quoted.isBaileys || !/Type.*tika/i.test(m.quoted.text)) return !0
    this.tebaktebakan = this.tebaktebakan ? this.tebaktebakan : {}
    if (!(id in this.tebaktebakan)) return m.reply('Soal that has berakhir')

...
`
        ...
        var dimas4 = `
Ngasih tau, kalo qalqalah that dipantulkan
`
...
`
        ...
        setTimeout(() => {
            conn.reply(m.chat, `Mencari teacher Ngaji.....`, m)
        }, 0) 
        user.lastngaji = Date.now()
    } else {
        let clock = clockString(timers)
        conn.reply(m.chat, `Sepertinya Kamu Sudah Kecapekan Please Istirahat Dulu Seold\n*${clock}*`, m)
    }
}
